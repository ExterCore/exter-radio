...
local function connectToRadio(channel)
    ...
    if onRadio then
        ...
        if Config.VoiceSystem == "pma-voice" then
            ...
            exports['exter-hud']:radioenter(true)
        end
    end
    if Config.VoiceSystem == "pma-voice" then
        exports["pma-voice"]:setRadioChannel(channel)
        exports['exter-hud']:radioenter(true, channel)
    elseif Config.VoiceSystem == "saltychat" then
...
function leaveRadio()
    ...
    if Config.VoiceSystem == "pma-voice" then
        ...
        exports['exter-hud']:radioenter(false)
...
RegisterNetEvent('exter-radio:use:client', function()
...
Citizen.CreateThread(function()
    -- Volume
	local volumeData = GetResourceKvpString('volume-exter-radio')
...
RegisterNUICallback('callback', function(data)
    ...
    elseif data.action == "volumeDown" then
        if RadioVolume > 1 then
            ...
            SetResourceKvp('volume-exter-radio', RadioVolume)
        end
